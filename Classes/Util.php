<?php
namespace Karatbars\KaratbarsTools;
...
class Util
{
    ...
    /**
     * Gets the KaratbarsTools configuration for a specific root page id.
     * To be used from the backend.
     *
     * @param int $pageId Id of the (root) page to get the KaratbarsTools configuration from.
     * @param bool $initializeTsfe Optionally initializes a full TSFE to get the configuration, defaults to FALSE
     * @param int $language System language uid, optional, defaults to 0
     * @return TypoScriptConfiguration The KaratbarsTools configuration for the requested tree.
     */
    public static function getKaratbarsToolsConfigurationFromPageId($pageId, $initializeTsfe = false, $language = 0)
    {
        $rootPath = '';
    ...
    /**
     * Initializes a TSFE, if required and builds an configuration array, containing the karatbarstools configuration.
     *
