<?php
namespace Karatbars\KaratbarsTools\System\Configuration;
...
use Karatbars\KaratbarsTools\IndexQueue\Indexer;
use Karatbars\KaratbarsTools\IndexQueue\Initializer\Record;
use Karatbars\KaratbarsTools\System\ContentObject\ContentObjectService;
use Karatbars\KaratbarsTools\System\Util\ArrayAccessor;
...
{
    /**
     * @var \Karatbars\KaratbarsTools\System\Util\ArrayAccessor|null
     */
     ...
     *
     * In the context of an frontend content element the path plugin.tx_karatbars_tools is
     * merged recursive with overrule with the content element specific typoscript
     * settings, like plugin.tx_karatbars_tools_PiResults_Results, and possible flex form settings
     * (depends on the karatbars_tools plugin).
     *
     * Example: plugin.tx_karatbars_tools.foo.bar
     * returns $GLOBALS['TSFE']->tmpl->setup['plugin.']['tx_karatbars_tools.']['foo.']['bar']
     *
     ...
     * merged recursive with overrule with the content element specific typoscript
     * settings, like plugin.tx_karatbars_tools_PiResults_Results, and possible flex form settings
     * (depends on the karatbarstools plugin).
     *
     * Example: plugin.tx_karatbars_tools.foo.bar
     * returns $GLOBALS['TSFE']->tmpl->setup['plugin.']['tx_karatbars_tools.']['foo.']['bar']
     * which is a KARATBARSTOOLS_CONTENT cObj.
     *
     * @param string $path TypoScript path
     ...
     */
    public function mergeKaratbarsToolsConfiguration(array $configurationToMerge, $addKeys = true, $includeEmptyValues = true, $enableUnsetFeature = true)
    {
        $data = $this->configurationAccess->getData();
        ArrayUtility::mergeRecursiveWithOverrule(
            $data['plugin.']['tx_karatbars_tools.'],
    ...
    /**
     * Returns true when ext_karatbarstools is enabled
     *
    ...
    {
        $path = 'plugin.tx_karatbars_tools.enabled';
     ...
     *
     * plugin.tx_karatbars_tools.index.additionalFields.
     *
    ...
    {
        $result = $this->getObjectByPathOrDefault('plugin.tx_karatbars_tools.index.additionalFields.', $defaultIfEmpty);
        return $result;
    }

    /**
     * Returns all karatbarstools fields names where a mapping is configured in index.additionalFields
     *
     ...
     *
     * plugin.tx_karatbars_tools.index.fieldProcessingInstructions.
     *
     * @param array $defaultIfEmpty
     * @return array
     */
    ...
    {
        $result = $this->getObjectByPathOrDefault('plugin.tx_karatbars_tools.index.fieldProcessingInstructions.', $defaultIfEmpty);
        return $result;
    }
     ...
     *
     * plugin.tx_karatbars_tools.index.queue.<configurationName>.
     *
    ...
    {
        $path = 'plugin.tx_karatbars_tools.index.queue.' . $configurationName . '.';
     ...
     *
     * plugin.tx_karatbars_tools.index.queue.pages.additionalPageIds
     *
     * @param string $configurationName
     * @param array $defaultIfEmpty
     * @return array
    ...
    {
        $path = 'plugin.tx_karatbars_tools.index.queue.' . $configurationName . '.additionalPageIds';
     ...
     *
     * plugin.tx_karatbars_tools.index.queue.pages.allowedPageTypes
     *
    ...
    {
        $path = 'plugin.tx_karatbars_tools.index.queue.' . $configurationName . '.allowedPageTypes';
        $result = $this->getValueByPathOrDefaultValue($path, '');
        if (trim($result) === '') {
            return $defaultIfEmpty;
        }
     ...
     *
     * plugin.tx_karatbars_tools.index.queue.pages.excludeContentByClass
     *
     * @param array $defaultIfEmpty
     * @return array
     */
    ...
    {
        $path = 'plugin.tx_karatbars_tools.index.queue.pages.excludeContentByClass';
        $result = $this->getValueByPathOrDefaultValue($path, '');
     ...
     *
     * plugin.tx_karatbars_tools.index.queue.<configurationName>.table or configurationName
     *
     * @param string $configurationName
     * @return string
     */
    ...
    {
        $path = 'plugin.tx_karatbars_tools.index.queue.' . $configurationName . '.table';
     ...
     *
     * plugin.tx_karatbars_tools.index.queue.<configurationName>.fields.
     *
     * @param string $configurationName
     * @param array $defaultIfEmpty
     * @return array
    ...
    {
        $path = 'plugin.tx_karatbars_tools.index.queue.' . $configurationName . '.fields.';
        $result = $this->getObjectByPathOrDefault($path, $defaultIfEmpty);
        return $result;
    }
     ...
     * By default "Karatbars\KaratbarsTools\IndexQueue\Indexer" will be returned.
     *
     * plugin.tx_karatbars_tools.index.queue.<configurationName>.indexer
     *
     * @param string $configurationName
    ...
    {
        $path = 'plugin.tx_karatbars_tools.index.queue.' . $configurationName . '.indexer';
        $result = $this->getValueByPathOrDefaultValue($path, $defaultIfEmpty);
        return $result;
    }
    ...
    /**
     * Returns all karatbarstools fields names where a mapping configuration is set for a certain index configuration
     *
     * Returns all keys from
     * plugin.tx_karatbars_tools.index.queue.<configurationName>.fields.
     *
     ...
     *
     * plugin.tx_karatbars_tools.index.queue.<configurationName> = 1
     *
     * @param string $configurationName
    ...
    {
        $tablesToIndex = [];
        $path = 'plugin.tx_karatbars_tools.index.queue.';
     ...
     *
     * plugin.tx_karatbars_tools.index.queue.recursiveUpdateFields
     *
     * @param string $configurationName
     * @param array $defaultIfEmpty
     * @return array
    ...
    {
        $path = 'plugin.tx_karatbars_tools.index.queue.' . $configurationName . '.recursiveUpdateFields';
     ...
     *
     * plugin.tx_karatbars_tools.index.queue.<configurationName>.initialPagesAdditionalWhereClause
     *
     * @param string $configurationName
     * @return string
     */
    ...
    {
        $path = 'plugin.tx_karatbars_tools.index.queue.' . $configurationName . '.initialPagesAdditionalWhereClause';
     ...
     *
     * plugin.tx_karatbars_tools.index.queue.<configurationName>.additionalWhereClause
     *
     * @param string $configurationName
     * @return string
     */
    ...
    {
        $path = 'plugin.tx_karatbars_tools.index.queue.' . $configurationName . '.additionalWhereClause';
     ...
     *
     * plugin.tx_karatbars_tools.index.queue.<configurationName>.initialization
     *
     * @param string $configurationName
     * @param string $defaultIfEmpty
     * @return string
    ...
    {
        $path = 'plugin.tx_karatbars_tools.index.queue.' . $configurationName . '.initialization';
     ...
     *
     * plugin.tx_karatbars_tools._LOCAL_LANG.
     *
     * @param array $defaultIfEmpty
     * @return array
     */
    ...
    {
        $result = $this->getObjectByPathOrDefault('plugin.tx_karatbars_tools._LOCAL_LANG.', $defaultIfEmpty);
        return $result;
    }
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.logging.debugOutput', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.logging.query.filters
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.logging.query.filters', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.logging.query.queryString
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.logging.query.queryString', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.logging.query.searchWords
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.logging.query.searchWords', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.logging.query.rawGet
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.logging.query.rawGet', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.logging.query.rawPost
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.logging.query.rawPost', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.logging.query.rawDelete
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.logging.query.rawDelete', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.logging.exceptions
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.logging.exceptions', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.logging.indexing
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.logging.indexing', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.logging.indexing.queue
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.logging.indexing.queue', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.logging.indexing.queue.<indexQueueConfiguration>
     *
    ...
    public function getLoggingIndexingQueueOperationsByConfigurationNameWithFallBack($indexQueueConfiguration, $defaultIfEmpty = false)
    {
        ...
        $path = 'plugin.tx_karatbars_tools.logging.indexing.queue.' . $indexQueueConfiguration;
        $result = $this->getValueByPathOrDefaultValue($path, $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.logging.indexing.pageIndexed
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.logging.indexing.pageIndexed', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.logging.indexing.missingTypo3SearchMarkers
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.logging.indexing.missingTypo3SearchMarkers', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.logging.indexing.indexQueueInitialization
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.logging.indexing.indexQueueInitialization', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.enableDebugMode
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.enableDebugMode', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     * @return array|mixed
     */
    public function getOutFilesConfig($defaultIfEmpty = [])
    {
        $result = $this->getObjectByPathOrDefault('plugin.tx_karatbars_tools.', $defaultIfEmpty);
        return $result == is_array($result['outFiles.']) ? $result['outFiles.'] : $defaultIfEmpty;
    }

    /**
     * Returns true or false if something is configured below plugin.tx_karatbars_tools.karatbarstools.
     *
     * plugin.tx_karatbars_tools.karatbarstools.
     *
     * @param boolean $defaultIfEmpty
     * @return boolean
     */
    public function getKaratbarsToolsHasConnectionConfiguration($defaultIfEmpty = false)
    {
        $configuration = $this->getObjectByPathOrDefault('plugin.tx_karatbars_tools.karatbarstools.', []);
        return $configuration !== [] ? true : $defaultIfEmpty;
    }

    /**
     * Returns the defaultTimeout used for requests to the Karatbars server
     *
     * plugin.tx_karatbars_tools.karatbarstools.timeout
     *
     * @param int $defaultIfEmpty
     * @return int
     */
    public function getKaratbarsToolsTimeout($defaultIfEmpty = 0, $scope = 'read')
    {
        $scopePath = 'plugin.tx_karatbars_tools.karatbarstools.' . $scope . '.timeout';
        $fallbackPath = 'plugin.tx_karatbars_tools.karatbarstools.timeout';
    ...
    /**
     * Returns the scheme used for requests to the Karatbars server
     *
     * plugin.tx_karatbars_tools.karatbarstools.scheme
     *
     ...
     * @return string
     */
    public function getKaratbarsToolsScheme($defaultIfEmpty = 'http', $scope = 'read')
    {
        $scopePath = 'plugin.tx_karatbars_tools.karatbarstools.' . $scope . '.scheme';
        $fallbackPath = 'plugin.tx_karatbars_tools.karatbarstools.scheme';

        return $this->getValueByPathWithFallbackOrDefaultValueAndApplyStdWrap($scopePath, $fallbackPath, $defaultIfEmpty);
    }

    /**
     * Returns the hostname used for requests to the Karatbars server
     *
     * plugin.tx_karatbars_tools.karatbarstools.host
     *
     * Applies stdWrap on the configured setting
     *
     * @param string $defaultIfEmpty
     ...
     * @return string
     */
    public function getKaratbarsToolsHost($defaultIfEmpty = 'localhost', $scope = 'read')
    {
        $scopePath = 'plugin.tx_karatbars_tools.karatbarstools.' . $scope . '.host';
        $fallbackPath = 'plugin.tx_karatbars_tools.karatbarstools.host';

        return $this->getValueByPathWithFallbackOrDefaultValueAndApplyStdWrap($scopePath, $fallbackPath, $defaultIfEmpty);
    }

    /**
     * Returns the port used for requests to the Karatbars server
     *
     * plugin.tx_karatbars_tools.karatbarstools.port
     *
     * Applies stdWrap on the configured setting
     *
     * @param int $defaultIfEmpty
     ...
     * @return int
     */
    public function getKaratbarsToolsPort($defaultIfEmpty = 8983, $scope = 'read')
    {
        $scopePath = 'plugin.tx_karatbars_tools.karatbarstools.' . $scope . '.port';
        $fallbackPath = 'plugin.tx_karatbars_tools.karatbarstools.port';

        return (int)$this->getValueByPathWithFallbackOrDefaultValueAndApplyStdWrap($scopePath, $fallbackPath, $defaultIfEmpty);
    }

    /**
     * Returns the path used for requests to the Karatbars server
     *
     * plugin.tx_karatbars_tools.karatbarstools.path
     *
     * Applies stdWrap on the configured setting
     *
     * @param string $defaultIfEmpty
     ...
     * @return string
     */
    public function getKaratbarsToolsPath($defaultIfEmpty = '/karatbarstools/core_en/', $scope = 'read')
    {
        $scopePath = 'plugin.tx_karatbars_tools.karatbarstools.' . $scope . '.path';
        $fallbackPath = 'plugin.tx_karatbars_tools.karatbarstools.path';

        $karatbarstoolsPath =  $this->getValueByPathWithFallbackOrDefaultValueAndApplyStdWrap($scopePath, $fallbackPath, $defaultIfEmpty);

        $karatbarstoolsPath = trim($karatbarstoolsPath, '/');
        $karatbarstoolsPath = '/' . $karatbarstoolsPath . '/';

        return $karatbarstoolsPath;
    }

    /**
     * Returns the username used for requests to the Karatbars server
     *
     * plugin.tx_karatbars_tools.karatbarstools.username
     *
     * Applies stdWrap on the configured setting
     *
     * @param string $defaultIfEmpty
     ...
     * @return string
     */
    public function getKaratbarsToolsUsername($defaultIfEmpty = '', $scope = 'read')
    {
        $scopePath = 'plugin.tx_karatbars_tools.karatbarstools.' . $scope . '.username';
        $fallbackPath = 'plugin.tx_karatbars_tools.karatbarstools.username';

        return $this->getValueByPathWithFallbackOrDefaultValueAndApplyStdWrap($scopePath, $fallbackPath, $defaultIfEmpty);
    }

    /**
     * Returns the password used for requests to the Karatbars server
     *
     * plugin.tx_karatbars_tools.karatbarstools.password
     *
     * Applies stdWrap on the configured setting
     *
     * @param string $defaultIfEmpty
     ...
     * @return string
     */
    public function getKaratbarsToolsPassword($defaultIfEmpty = '', $scope = 'read')
    {
        $scopePath = 'plugin.tx_karatbars_tools.karatbarstools.' . $scope . '.password';
        $fallbackPath = 'plugin.tx_karatbars_tools.karatbarstools.password';
     ...
     *
     * plugin.tx_karatbars_tools.search.
     *
     * @param array $defaultIfEmpty
     * @return array
     */
    ...
    {
        $result = $this->getObjectByPathOrDefault('plugin.tx_karatbars_tools.search.', $defaultIfEmpty);
        return $result;
    }
     ...
     *
     * plugin.tx_karatbars_tools.search.elevation
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.elevation', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.search.elevation.markElevatedResults
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.elevation.markElevatedResults', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     *plugin.tx_karatbars_tools.search.elevation.forceElevation
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.elevation.forceElevation', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.search.variants
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.variants', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.search.variants.variantField
     *
     * @param string $defaultIfEmpty
     * @return string
     */
    ...
    {
        return $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.variants.variantField', $defaultIfEmpty);
    }

    /**
     * Indicates if expanding of collapsed items it activated.
     *
     * plugin.tx_karatbars_tools.search.variants.expand
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.variants.expand', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.search.variants.limit
     *
     * @param int $defaultIfEmpty
     * @return int
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.variants.limit', $defaultIfEmpty);
        return (int)$result;
    }
     ...
     *
     * plugin.tx_karatbars_tools.search.frequentSearches
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.frequentSearches', $defaultIfEmpty);
        return $this->getBool($result);
    }
    ...
    {
        $result = $this->getObjectByPathOrDefault('plugin.tx_karatbars_tools.search.frequentSearches.', $defaultIfEmpty);
        return $result;
    }
     ...
     *
     * plugin.tx_karatbars_tools.search.frequentSearches.minSize
     *
     * @param int $defaultIfEmpty
     * @return int
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.frequentSearches.minSize', $defaultIfEmpty);
        return (int)$result;
    }
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.frequentSearches.maxSize', $defaultIfEmpty);
        return (int)$result;
    }
     ...
     * Indicates if frequent searches should be show or not.
     *
     * plugin.tx_karatbars_tools.search.frequentSearches.useLowercaseKeywords
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.frequentSearches.useLowercaseKeywords', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.search.initializeWithEmptyQuery
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.initializeWithEmptyQuery', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.search.initializeWithQuery
     *
     * @param string $defaultIfEmpty
     * @return string
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.initializeWithQuery', $defaultIfEmpty);
     ...
     *
     * plugin.tx_karatbars_tools.search.lastSearches
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.lastSearches', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.search.lastSearches.mode
     *
     * @param string $defaultIfEmpty
     * @return string
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.lastSearches.mode', $defaultIfEmpty);
        return (string)$result;
    }
     ...
     *
     * plugin.tx_karatbars_tools.search.lastSearches.limit
     *
     * @param int $defaultIfEmpty
     * @return int
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.lastSearches.limit', $defaultIfEmpty);
        return (int)$result;
    }
     ...
     *
     * plugin.tx_karatbars_tools.search.showResultsOfInitialEmptyQuery
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.showResultsOfInitialEmptyQuery', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.search.showResultsOfInitialQuery
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.showResultsOfInitialQuery', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.search.sorting
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.sorting', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.search.sorting.options.
     *
     * @param array $defaultIfEmpty
     * @return array
     */
    ...
    {
        $result = $this->getObjectByPathOrDefault('plugin.tx_karatbars_tools.search.sorting.options.', $defaultIfEmpty);
        return $result;
    }
     ...
     *
     * plugin.tx_karatbars_tools.search.sorting.options.<sortOptionName>.defaultOrder
     *
     * or
     *
     * plugin.tx_karatbars_tools.search.sorting.defaultOrder
     *
     *
    ...
    {
        $sortOrderSpecificPath = 'plugin.tx_karatbars_tools.search.sorting.options.' . $sortOptionName . '.defaultOrder';
        ...
        $commonPath = 'plugin.tx_karatbars_tools.search.sorting.defaultOrder';
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.trustedFields', '');
     ...
     *
     * plugin.tx_karatbars_tools.search.keepExistingParametersForNewSearches
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.keepExistingParametersForNewSearches', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.search.query.allowEmptyQuery
     *
     * @param string $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.query.allowEmptyQuery', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.search.query.filter.
     *
     * @param array $defaultIfEmpty
     * @return array
     */
    ...
    {
        $result = $this->getObjectByPathOrDefault('plugin.tx_karatbars_tools.search.query.filter.', $defaultIfEmpty);
        return $result;
    }
    ...
    {
        $this->configurationAccess->set('plugin.tx_karatbars_tools.search.query.filter.', $configuration);
    }
    ...
    {
        $this->configurationAccess->reset('plugin.tx_karatbars_tools.search.query.filter.__pageSections');
    }

    /**
     * Returns the configured queryFields from TypoScript
     *
     * plugin.tx_karatbars_tools.search.query.queryFields
     *
     * @param string $defaultIfEmpty
     * @return string
     */
    ...
    {
        return $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.query.queryFields', $defaultIfEmpty);
    }

    /**
     * This method is used to check if a phrase search is enabled or not
     *
     * plugin.tx_karatbars_tools.search.query.phrase = 1
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.query.phrase', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.search.query.phrase.fields
     *
     * @param string $defaultIfEmpty
     * @return string
     */
    ...
    {
        return $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.query.phrase.fields', $defaultIfEmpty);
    }

    /**
     * This method is used to check if a bigram phrase search is enabled or not
     *
     * plugin.tx_karatbars_tools.search.query.bigramPhrase = 1
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.query.bigramPhrase', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     * Returns the configured phrase fields from TypoScript
     *
     * plugin.tx_karatbars_tools.search.query.bigramPhrase.fields
     *
     * @param string $defaultIfEmpty
     * @return string
     */
    ...
    {
        return $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.query.bigramPhrase.fields', $defaultIfEmpty);
    }

    /**
     * This method is used to check if a trigram phrase search is enabled or not
     *
     * plugin.tx_karatbars_tools.search.query.trigramPhrase = 1
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.query.trigramPhrase', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.search.query.trigramPhrase.fields
     *
     * @param string $defaultIfEmpty
     * @return string
     */
    ...
    {
        return $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.query.trigramPhrase.fields', $defaultIfEmpty);
    }

    /**
     * Returns the configured returnFields as array.
     *
     * plugin.tx_karatbars_tools.search.query.returnFields
     *
     * @param array $defaultIfEmpty
     * @return array
     */
    ...
    {
        $returnFields = $this->getValueByPath('plugin.tx_karatbars_tools.search.query.returnFields');
     ...
     *
     * plugin.tx_karatbars_tools.search.targetPage
     *
     * @return int
     */
    public function getSearchTargetPage()
    {
        $targetPage = (int)$this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.targetPage', 0);
        if ($targetPage === 0) {
    ...
    {
        $result = $this->getObjectByPathOrDefault('plugin.tx_karatbars_tools.search.targetPage.', $defaultIfEmpty);
        return $result;
    }
     ...
     *
     * plugin.tx_karatbars_tools.searcb.results.siteHighlighting
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $isSiteHightlightingEnabled = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.results.siteHighlighting', $defaultIfEmpty);
     ...
     *
     * plugin.tx_karatbars_tools.search.results.resultsHighlighting
     *
     * @param boolean $defaultIfEmpty
     * @return boolean
     */
    ...
    {
        $isHighlightingEnabled = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.results.resultsHighlighting', $defaultIfEmpty);
     ...
     *
     * plugin.tx_karatbars_tools.search.results.resultsHighlighting.highlightFields
     *
     * @param string $defaultIfEmpty
     * @return string
     */
    ...
    {
        return $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.results.resultsHighlighting.highlightFields', $defaultIfEmpty);
    }
     ...
     *
     * plugin.tx_karatbars_tools.search.results.resultsHighlighting.fragmentSize
     *
     * @param int $defaultIfEmpty
     * @return int
     */
    ...
    {
        return (int)$this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.results.resultsHighlighting.fragmentSize', $defaultIfEmpty);
    }

    /**
     * Returns the fragmentSeparator for highlighted segments.
     *
     * plugin.tx_karatbars_tools.search.results.resultsHighlighting.fragmentSeparator
     *
     * @param string $defaultIfEmpty
     * @return string
     */
    ...
    {
        return $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.results.resultsHighlighting.fragmentSeparator', $defaultIfEmpty);
    }

    /**
     * Returns the number of results that should be shown per page.
     *
     * plugin.tx_karatbars_tools.search.results.resultsPerPage
     *
     * @param int $defaultIfEmpty
     * @return int
     */
    ...
    {
        return (int)$this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.results.resultsPerPage', $defaultIfEmpty);
    }

    /**
     * Returns the available options for the per page switch.
     *
     * plugin.tx_karatbars_tools.search.results.resultsPerPageSwitchOptions
     *
     * @param array $defaultIfEmpty
     * @return array
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.results.resultsPerPageSwitchOptions', '');
     ...
     *
     * plugin.tx_karatbars_tools.search.results.resultsHighlighting.wrap
     *
     * @param string $defaultIfEmpty
     * @return string
     */
    ...
    {
        return $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.results.resultsHighlighting.wrap', $defaultIfEmpty);
    }

    /**
     * Indicates if spellchecking is enabled or not.
     *
     * plugin.tx_karatbars_tools.search.spellchecking
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $isFacetingEnabled = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.spellchecking', $defaultIfEmpty);
     ...
     *
     * plugin.tx_karatbars_tools.search.spellchecking.numberOfSuggestionsToTry
     *
     * @param int $defaultIfEmpty
     * @return int
     */
    ...
    {
        return (int)$this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.spellchecking.numberOfSuggestionsToTry', $defaultIfEmpty);
    }

    /**
     * Indicates if a second search should be fired from the spellchecking suggestion if no results could be found.
     *
     * plugin.tx_karatbars_tools.search.spellchecking.searchUsingSpellCheckerSuggestion
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.spellchecking.searchUsingSpellCheckerSuggestion', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_karatbars_tools.search.faceting
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $isFacetingEnabled = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.faceting', $defaultIfEmpty);
        return $this->getBool($isFacetingEnabled);
    }
     ...
     *
     * plugin.tx_karatbars_tools.search.faceting.facets.<facetName>.showEvenWhenEmpty
     *
     * or
     *
     * plugin.tx_karatbars_tools.search.faceting.showEmptyFacets
     *
     *
    ...
    {
        $facetSpecificPath = 'plugin.tx_karatbars_tools.search.faceting.facets.' . $facetName . '.showEvenWhenEmpty';
        ...
        // no specific setting, check common setting
        $commonPath = 'plugin.tx_karatbars_tools.search.faceting.showEmptyFacets';
     ...
     *
     * plugin.tx_karatbars_tools.search.faceting.showAllLink.wrap
     *
     * @param string $defaultIfEmpty
     * @return string
     */
    ...
    {
        return (string)$this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.faceting.showAllLink.wrap', $defaultIfEmpty);
    }

    /**
     * Returns the link url parameters that should be added to a facet.
     *
     * plugin.tx_karatbars_tools.search.faceting.facetLinkUrlParameters
     *
     * @param string $defaultIfEmpty
     * @return string
     */
    ...
    {
        $linkUrlParameters = trim($this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.faceting.facetLinkUrlParameters', $defaultIfEmpty));
     ...
     *
     * plugin.tx_karatbars_tools.search.faceting.facetLinkUrlParameters.useForFacetResetLinkUrl
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $useForFacetResetLinkUrl = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.faceting.facetLinkUrlParameters.useForFacetResetLinkUrl', $defaultIfEmpty);
     ...
     *
     * plugin.tx_karatbars_tools.search.faceting.minimumCount
     *
     * @param int $defaultIfEmpty
     * @return int
     */
    ...
    {
        return (int)$this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.faceting.minimumCount', $defaultIfEmpty);
    }

    /**
     * Return the configured limit value for facets, used for displaying.
     *
     * plugin.tx_karatbars_tools.search.faceting.limit
     *
     * @param int $defaultIfEmpty
     * @return int
     */
    ...
    {
        return (int)$this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.faceting.limit', $defaultIfEmpty);
    }

    /**
     * Return the configured limit value for facets, used for the response.
     *
     * plugin.tx_karatbars_tools.search.faceting.facetLimit
     *
     * @param int $defaultIfEmpty
     * @return int
     */
    ...
    {
        return (int)$this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.faceting.facetLimit', $defaultIfEmpty);
    }

    /**
     * Returns if the singleFacetMode is active or not.
     *
     * plugin.tx_karatbars_tools.search.faceting.singleFacetMode
     *
    ...
    {
        trigger_error('TypoScriptConfiguration::getSearchFacetingSingleFacetMode is deprecated please use partialName=OptionsSinglemode typoscript configuration for that. Will be removed in EXT:karatbars_tools 10', E_USER_DEPRECATED);

        $singleFacetMode = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.faceting.singleFacetMode', $defaultIfEmpty);
     ...
     *
     * plugin.tx_karatbars_tools.search.faceting.sortBy
     *
     * @param string $defaultIfEmpty
     * @return string
     */
    ...
    {
        return $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.faceting.sortBy', $defaultIfEmpty);
    }

    /**
     * Returns if a facets should be kept on selection. Global faceting setting
     * can also be configured on facet level by using
     * (plugin.tx_karatbars_tools.search.faceting.facets.<fieldName>.keepAllOptionsOnSelection)
     *
     * plugin.tx_karatbars_tools.search.faceting.keepAllFacetsOnSelection
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $keepAllOptionsOnSelection = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.faceting.keepAllFacetsOnSelection', $defaultIfEmpty);
     ...
     * plugin.tx_karatbars_tools.search.faceting.keepAllFacetsOnSelection has been enabled
     *
     * plugin.tx_karatbars_tools.search.faceting.countAllFacetsForSelection
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $countAllFacetsForSelection = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.faceting.countAllFacetsForSelection', $defaultIfEmpty);
     ...
     *
     * plugin.tx_karatbars_tools.search.faceting.facets
     *
     * @param array $defaultIfEmpty
     * @return array
     */
    ...
    {
        return $this->getObjectByPathOrDefault('plugin.tx_karatbars_tools.search.faceting.facets.', $defaultIfEmpty);
    }

    /**
     * Returns the configuration of a single facet by facet name.
     *
     * plugin.tx_karatbars_tools.search.faceting.facets.<facetName>
     *
     * @param string $facetName
     * @param array $defaultIfEmpty
     * @return array
    ...
    {
        return $this->getObjectByPathOrDefault('plugin.tx_karatbars_tools.search.faceting.facets.' . $facetName . '.', $defaultIfEmpty);
    }

    /**
     * Indicates if statistics is enabled or not.
     *
     * plugin.tx_karatbars_tools.statistics
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $isStatisticsEnabled = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.statistics', $defaultIfEmpty);
     ...
     *
     * plugin.tx_karatbars_tools.statistics.anonymizeIP
     *
     * @param int $defaultIfEmpty
     * @return int
     */
    ...
    {
        $anonymizeToLength = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.statistics.anonymizeIP', $defaultIfEmpty);
     ...
     *
     * plugin.tx_karatbars_tools.statistics.addDebugData
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $statisticsAddDebugDataEnabled = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.statistics.addDebugData', $defaultIfEmpty);
     ...
     *
     * plugin.tx_karatbars_tools.suggest
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $isSuggestionEnabled = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.suggest', $defaultIfEmpty);
     ...
     *
     * plugin.tx_karatbars_tools.suggest.forceHttps
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $isHttpsForced = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.suggest.forceHttps', $defaultIfEmpty);
     ...
     *
     * plugin.tx_karatbars_tools.suggest.numberOfSuggestions
     *
     * @param int $defaultIfEmpty
     * @return int
     */
    ...
    {
        $numberOfSuggestions = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.suggest.numberOfSuggestions', $defaultIfEmpty);
     ...
     *
     * plugin.tx_karatbars_tools.suggest.showTopResults
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $showTopResults = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.suggest.showTopResults', $defaultIfEmpty);
     ...
     *
     * plugin.tx_karatbars_tools.suggest.numberOfTopResults
     *
     * @param int $defaultIfEmpty
     * @return int
     */
    ...
    {
        $numberOfTopResults = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.suggest.numberOfTopResults', $defaultIfEmpty);
     ...
     *
     * plugin.tx_karatbars_tools.suggest.additionalTopResultsFields
     *
     * @param array $defaultIfEmpty
     * @return array
     */
    ...
    {
        $additionalTopResultsFields = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.suggest.additionalTopResultsFields', '');
     ...
     *
     * plugin.tx_karatbars_tools.view.templateFiles.<fileKey>
     *
    ...
    {
        $templateFileName = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.view.templateFiles.' . $fileKey, $defaultIfEmpty);
     ...
     *
     * plugin.tx_karatbars_tools.view.templateFiles.[fileKey].availableTemplates.
     *
     * @param string $fileKey
     * @return array
     */
    ...
    {
        $path = 'plugin.tx_karatbars_tools.view.templateFiles.' . $fileKey . '.availableTemplates.';
     ...
     *
     * plugin.tx_karatbars_tools.viewHelpers.crop.
     *
     * @param array $defaultIfEmpty
     * @return array
     */
    ...
    {
        $cropViewHelperConfiguration = $this->getObjectByPathOrDefault('plugin.tx_karatbars_tools.viewHelpers.crop.', $defaultIfEmpty);
     ...
     *
     * plugin.tx_karatbars_tools.viewHelpers.sortIndicator.
     *
     * @param array $defaultIfEmpty
     * @return array
     */
    ...
    {
        $sortingViewHelperConfiguration = $this->getObjectByPathOrDefault('plugin.tx_karatbars_tools.viewHelpers.sortIndicator.', $defaultIfEmpty);
        return $sortingViewHelperConfiguration;
    }

    /**
     * Controls whether ext-karatbarstools will send commits to karatbarstools.
     ...
     * A good way to achieve this is enabling the karatbarstools
     * daemons autoCommit feature.
     *
     * plugin.tx_karatbars_tools.index.enableCommits
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $enableCommits = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.index.enableCommits', $defaultIfEmpty);
     ...
     *
     * plugin.tx_karatbars_tools.view.pluginNamespace
     *
     * @param string $defaultIfEmpty
     * @return string
     */
    public function getSearchPluginNamespace($defaultIfEmpty = 'tx_karatbars_tools')
    {
        return $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.view.pluginNamespace', $defaultIfEmpty);
    }
     ...
     *
     * plugin.tx_karatbars_tools.search.ignoreGlobalQParameter
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $enableQParameter = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.ignoreGlobalQParameter', $defaultIfEmpty);
     ...
     *
     * plugin.tx_karatbars_tools.search.additionalPersistentArgumentNames
     *
     * @param array $defaultIfEmpty
     * @return array
     */
    ...
    {
        $additionalPersistentArgumentNames = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.additionalPersistentArgumentNames', '');
     ...
     *
     * plugin.tx_karatbars_tools.search.grouping
     *
     * @param bool $defaultIfEmpty
     * @return bool
     */
    ...
    {
        $groupingEnabled = $this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.grouping', $defaultIfEmpty);
     ...
     *
     * plugin.tx_karatbars_tools.search.grouping.numberOfGroups
     *
     * @param int $defaultIfEmpty
     * @return int
     */
    ...
    {
        return (int)$this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.grouping.numberOfGroups', $defaultIfEmpty);
    }

    /**
     * Returns the sortBy configuration for the grouping.
     *
     * plugin.tx_karatbars_tools.search.grouping.sortBy
     *
     * @param string $defaultIfEmpty
     * @return string
     */
    ...
    {
        return (string)$this->getValueByPathOrDefaultValue('plugin.tx_karatbars_tools.search.grouping.sortBy', $defaultIfEmpty);
    }
    ...
    {
        $groupingConfiguration = $this->getObjectByPathOrDefault('plugin.tx_karatbars_tools.search.grouping.', []);
     ...
     * Returns:
     *
     * plugin.tx_karatbars_tools.search.grouping.groups.<groupName>.numberOfResultsPerGroup if it is set otherwise
     * plugin.tx_karatbars_tools.search.grouping.numberOfResultsPerGroup
     *
    ...
    {
        $specificPath = 'plugin.tx_karatbars_tools.search.grouping.groups.' . $groupName . 'numberOfResultsPerGroup';
        ...
        $commonPath = 'plugin.tx_karatbars_tools.search.grouping.numberOfResultsPerGroup';
    ...
    /**
     * Returns everything that is configured for the groups (plugin.tx_karatbars_tools.search.grouping.groups.)
     *
     * plugin.tx_karatbars_tools.search.grouping.groups.
     *
     * @param array $defaultIfEmpty
     * @return array
     */
    ...
    {
        return $this->getObjectByPathOrDefault('plugin.tx_karatbars_tools.search.grouping.groups.', $defaultIfEmpty);
    }
